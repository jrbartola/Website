	...
	render() {
		return (
			<div id="home">
                ...
                <p className="bio">I'm a Software Engineer, recently receiving my undergraduate degree in Computer Science and Mathematics from UMass Amherst in May 2019.
				...
				<p className="bio">Last summer I was a software engineer intern at Google on the Site Reliability team. I'm currently working as a Departmental Assistant for the College of Information and Computer Sciences at UMass, and
				    will be a Software Engineer at Hubspot come July.</p>
