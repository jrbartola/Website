...
export class Resume extends React.Component<ResumeProps, ResumeState> {
  ...
  componentDidMount() {
    GETRequest('https://api.github.com/users/jrbartola/repos')
      .then(resp => {
        const repos = this.mapRepositories('jrbartola', resp as object[]);
        const resps = repos.map(r =>
          GETRequest(`https://api.github.com/repos/jrbartola/${r}/languages`)
        );
  ...
  render() {
    ...
    const updatedText = width >= 692 ? '(Updated 11/29/2019)' : '';
    return (
      <div id="resume">
...
const Experience = () => {
  return (
    <AccordionItem expanded={true}>
      ...
      <AccordionItemBody>
        <ExperienceItem
          timeFrame="July 2019 - Now"
          company="HubSpot"
          location="Cambridge, MA"
          jobTitle="Software Engineer"
          description={HUBSPOT_SWE_DESC}
        ...
        <ExperienceItem
          ...
          description={GOOGLE_INTERN_DESC}
